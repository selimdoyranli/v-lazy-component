...
if (!argv.format || argv.format === 'umd') {
  const umdConfig = {
    ...
    output: [
      ...
      {
        file: 'dist/vue3/v-lazy-component.umd.js',
        format: 'umd',
        exports: 'named',
        globals,
        name: 'LazyComponent'
      ...
      {
        file: 'dist/vue3/v-lazy-component.umd.min.js',
        format: 'umd',
        exports: 'named',
        globals,
        name: 'LazyComponent',
...
if (!argv.format || argv.format === 'cjs') {
  const cjsConfig = {
    ...
    output: [
      {
        compact: true,
        file: 'dist/vue3/v-lazy-component.cjs',
        format: 'cjs',
        name: 'LazyComponent',
        exports: 'named',
        globals
      ...
      {
        compact: true,
        file: 'dist/vue3/v-lazy-component.min.cjs',
        format: 'cjs',
        name: 'LazyComponent',
        exports: 'named',
        globals,
